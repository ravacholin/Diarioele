...
@Database(entities=[SessionEntity::class,BlockEntity::class,AudioSegmentEntity::class,MarkerEntity::class,TranscriptSpanEntity::class,EvidenceClaimEntity::class,DiaryDraftEntity::class,DiaryEntryEntity::class,AppSettingEntity::class],version=3,exportSchema=false)
abstract class DiarioDatabase:RoomDatabase(){ abstract fun sessions():SessionDao
 companion object {
